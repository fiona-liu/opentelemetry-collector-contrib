...
const typeStr = "redisclient"

// NewFactory creates a factory for redisclient receiver.
...
func createDefaultConfig() config.Receiver {
	return &Config{
		...
		HTTPClientSettings: confighttp.HTTPClientSettings{
			Endpoint: fmt.Sprintf("http://localhost:%s/api/lastminstats", defaultPort),
...
func createMetricsReceiver(
	...
	ns := newRedisclientScraper(params.TelemetrySettings, cfg)
